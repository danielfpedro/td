...
<div class="container box-margin-top">
	<div class="row">
		<div class="col-md-8" style="background-color: #fff;">
			...
			<div class="row post-view-info box-margin-bottom-sm">
				<div class="col-md-5">
					<div class="">
						<img src="http://graph.facebook.com/v2.6/100001591518421/picture?type=square" class="img-circle post-view-author-profile-picture"> <a href="#">Daniel Cocota</a> <span class="post-view-pubdate"><?= $post->pub_date_in_words ?></span>
					</div>
				</div>
...
<!-- 				<div class="col-md-2 text-right">
				...
				<div class="col-md-12 post-view-body box-padding-left box-padding-right">
...
<a href="#"><span class="label label-light label-sm">Game Of Thrones</span></a>&nbsp;<a href="#"><span class="label label-light label-sm">Game Of Thrones</span></a>&nbsp;<a href="#"><span class="label label-light label-sm">Game Of Thrones</span></a>&nbsp;<span class="label label-light label-sm">Shaniqua</span>		
			...
			<div class="row box-margin-top-sm">
...
<noscript>Please enable JavaScript to view the <a href="https://disqus.com/?ref_noscript" rel="nofollow">comments powered by Disqus.</a></noscript>				
		...
		<div class="col-md-4">
			<div data-spy="affix" data-offset-top="100" data-offset-bottom="200">
